    ...
    <span class="text-center">
        <div class="col-md-4 mx-auto">
            <div class="panel panel-default" style="margin-bottom: 0">
              <div class="panel-body"><h2 class="display-4">Malussés</h2></div>
          </div>
          <div class="panel panel-default" style="margin-bottom: 0">
              <div class="panel-body"><h2 class="display-4">Sinistrés</h2></div>
          </div>
        </div>
        <div class="col-md-4 mx-auto">
            <div class="panel panel-default" style="margin-bottom: 0">
                <div class="panel-body"><h2 class="display-4">Non paiements</h2></div>
            </div>
            <div class="panel panel-default" style="margin-bottom: 0">
                <div class="panel-body"><h2 class="display-4">Permis étrangers</h2></div>
            </div>
        </div>
        <div id="devis" class="col-md-4 mx-auto">
            <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><button class="btn btn-lg display-4" style='width: 100%'>Demander un devis</button></a>
        </div>
    </span>
...
<!-- handling devis -->
    ...
    // Centers the modal and focus on #highlight
